...
export const TOKEN_APPEAR_DELAY_FRAMES = 12;
export const TOKEN_APPEAR_DURATION_FRAMES = 24; // Reduced from 45 to make it appear faster
export const TOKEN_EXPAND_DELAY_FRAMES =
  TOKEN_APPEAR_DELAY_FRAMES + TOKEN_APPEAR_DURATION_FRAMES + 0;
export const TOKEN_EXPAND_DURATION_FRAMES = 48;
